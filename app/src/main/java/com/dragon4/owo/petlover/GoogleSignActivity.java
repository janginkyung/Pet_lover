...
public class GoogleSignActivity extends BaseActivity implements
    ...
    public void loginUser(final FirebaseUser firebaseUser) {
        User.getInstance().setUserID(firebaseUser.getUid());
        User.getInstance().setUserName(firebaseUser.getDisplayName());
        User.getInstance().setUserPhotoURL(firebaseUser.getPhotoUrl().toString());
        User.getInstance().setUserEmail(firebaseUser.getEmail());

        // Write a message to the database
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference("user");
        myRef.push().setValue(User.getInstance());

    }


    private void moveToMapSearchActivity() {
        Intent intent = new Intent(GoogleSignActivity.this, PetLoverMainActivity.class);
